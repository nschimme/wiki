...
<div class="wiki-block">
   ...
   %h        Lists all available commands<br>   %L        Lists the lines of your message with lin<br>   %d 2      Deletes line 2 of your message<br>   %q        Cancels the message and exits the editor<br>   %e        Saves the message and exits the editor
