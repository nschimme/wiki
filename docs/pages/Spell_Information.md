...
description: 'If you want a list of all spells, visit this [Spell'
tags:
  - Help files
---
...
are: [Armour](./Armour_Spell.md), [Bless](./Bless.md), [Cure
Blindness](./Cure_Blindness.md), [Cure
Critic](./Cure_Critic.md), [Cure Light](./Cure_Light.md),
[Detect Evil](./Detect_Evil.md), [Detect
Invisibility](./Detect_Invisibility.md), [Detect
Magic](./Detect_Magic.md), [Detect
Poison](./Detect_Poison.md), [Heal](./Heal.md),
...
Vision](./Night_Vision.md), [Shield](./Shield_Spell.md).
...
See Also: [Backfire](./Backfire.md), [Cast](./Cast.md),
[Create Focus](./Create_Focus.md), [Spell List](./Spell.md)
