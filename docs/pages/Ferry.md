---
title: Ferry
description: 'Ferries are a comfortable way of crossing a [body of'
tags:
  - Help files
---
...
In order to start a trip by ferry, use the '[Board](./Board.md)'
command. When you reach your destination, you might have to
'[Leave](./Leave.md)' the ship, or you might disembark
