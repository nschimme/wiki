...
It should be noted, however, that some [stats](./stats.md) are
more suitable for certain classes than others.

## List of classes

- **[Cleric](./Cleric.md)** - A supportive caster who excels in
  healing

<!-- -->

- **[Mage](./Mage.md)** - A class who uses powerful volatile magic
  to deal damage

<!-- -->

- **[Thief](./Thief.md)** - The furtive lone-wolf who deals damage
  from the shadows

<!-- -->

- **[Warrior](./Warrior.md)** - The strongest of all the classes
