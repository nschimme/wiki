---
title: Warrior
description: 'Warriors are known to have more strength than the average player.'
---
...
[class](./Class.md). However, they are poor at all sorts of magic,
and if they learn [spells](./Spell.md), will never be able to cast
