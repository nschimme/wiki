...
\#substitute {Astron} {Astron [7pm-7am] (Early Spring)}<br>\#substitute {Birithon} {Birithon [7pm-7am] (Late Autumn)}<br>\#substitute {Blotmath} {Blotmath [8pm-7am] (Mid Autumn)}<br>\#substitute {Cerveth} {Cerveth [9pm-5am] (Early Summer)}<br>\#substitute {Forelithe} {Forelithe [8pm-6am] (Late Spring)}<br>\#substitute {Foreyule} {Foreyule [7pm-7am] (Late Autumn)}<br>\#substitute {Gwaeron} {Gwaeron [6pm-8am] (Late Winter)}<br>\#substitute {Gwirith} {Gwirith [7pm-7am] (Early Spring)}<br>\#substitute {Halimath} {Halimath [9pm-5am] (Late Summer)}<br>\#substitute {Hithui} {Hithui [8pm-7am] (Mid Autumn)}<br>\#substitute {Ivanneth} {Ivanneth [9pm-5am] (Late Summer)}<br>\#substitute {Lothron} {Lothron [8pm-7am] (Mid Spring)}<br>\#substitute {Narbeleth} {Narbeleth [8pm-6am] (Early Autumn)}<br>\#substitute {Narwain} {Narwain [6pm-8am] (Early Winter)}<br>\#substitute {Ninui} {Ninui [5pm-9am] (Mid Winter)}<br>\#substitute {Norui} {Norui [8pm-6am] (Late Spring)}<br>\#substitute {Rethe} {Rethe [6pm-8am] (Late Winter)}<br>\#substitute {Solmath} {Solmath [5pm-9am] (Mid Winter)}
