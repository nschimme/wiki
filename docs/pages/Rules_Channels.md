...
description: 'Each communication channel on MUME has a different purpose, please use'
---

Each communication channel on MUME has a different purpose, please use
them appropriately.

[Shout](./Shout.md): it is reserved for short, rare, very
important messages. Since it is impossible to turn it off, use this
channel very carefully.

[Narrate](./Narrate.md): A generic communication channel, which
...
[Sing](./Sing.md): A channel that can be used for any kind of
information, a gossip channel.

[Tell](./Tell.md): One-to-one communication, in any language you
feel like.

[Say](./Say.md): Used to talk to all people in one room, this
