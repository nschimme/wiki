...
- Khuzdul is a [Dwarven](./Dwarf.md) language, only a few people
  speak it seriously.
...
- Quenya is the language of the High [Elves](./Elf.md). It is old
  and now almost forgotten.

<!-- -->

- Sindarin is the common tongue of all [Elves](./Elf.md).
...
- Orkish is the language of the [Orcs](./Orc.md).
...
- Beorning is the language of the [Beornings](./Beorning.md).
