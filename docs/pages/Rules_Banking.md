---
title: Rules Banking
description: 'Banking is storing items and gold so that you may'
---
...
Another obvious form of banking is to [hide](./Hide.md) or hand
off your equipment for safekeeping whilst you deliberately
[DT](./Death_trap.md). Similarly, hiding equipment before you get
[pkilled](./Player_killing.md) is only allowed if you don't
...
mobs, hiding it in [rooms](./Mechanics.md#room), etc.
...
by another player's [orc](./Orc.md), and - later - character B
