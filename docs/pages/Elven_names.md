...
For Example: [Elrond](./wikipedia:en:Elrond.md) means 'Vault of
Heaven', or 'Starry-dome' (El = Star ; Rod/Rond = domed roof). (See
also: '[The Lhamas](./wikipedia:en:The_Lhamas.md)' -
[Tolkien](./wikipedia:en:J._R._R._Tolkien.md)'s linguistic
dictionary, in [book
...
[Elvish](./wikipedia:en:Elvish.md) (see below), it is not
required. However, names that are not translated into Elvish, must then
be in [English](./wikipedia:en:English.md)
([FAQ1](./FAQ1.md)), and of course, please attempt to stay with
the adjective-noun format to your name (e.g. Stardome,
[Greenleaf](./wikipedia:en:Legolas_Greenleaf.md),
[Strongbow](./wikipedia:en:Beleg_Strongbow.md), etc.), while
...
derivation, [Dwarves](./Dwarves.md), [Orcs](./Orc.md), and
