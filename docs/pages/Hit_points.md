---
title: Hit points
description: 'Hit points (hps) is a way of representing how much physical damage'
tags:
  - Help files
---
**Hit points** (hps) is a way of representing how much physical damage
your character can endure before [dying](./Death.md). Being low on
...
[prompt](./Prompt.md). If nothing is shown, it means your are not
...
See also: [Mana](./Mana.md), [Movement
