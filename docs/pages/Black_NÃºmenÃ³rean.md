...
description: 'In J. R. R. Tolkien''s fictional prehistory of the'
tags:
  - Playable races
---
...
corrupted by [Sauron](./Sauron.md), coming to hate all good
...
[Dúnedain](./Dúnedain.md) of Gondor, but were permanently
...
- A BN will see free peoples by name or race only eg. \*an Elf\*. They
  can however see and group both [orcs](./Orc.md) and
  [trolls](./Troll.md), thus proving to be valuable aides.
