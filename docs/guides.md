---
title: Guides
description: Player guides and tutorials for MUME — from newbie basics to advanced strategy.
---
...
- [**General guide with rare useful information**](./pages/General_guide_with_rare_useful_information.md)
  Our most popular community resource. A compilation of essential tips, skill caps, and "rare" knowledge for both new and veteran players.

## Newbie Tutorial Series
...
16. [**Healing & Herblores**](./pages/Newbie_Guide_Herblores.md) ([Wounds](./pages/Newbie_Guide_Disease,_Poison,_and_Wounds.md)) — Staying alive.
17. [**Death**](./pages/Death.md) ([Guide](./pages/Newbie_Guide_Aging_and_Death.md)) — What happens when you fall.
...
Deep dives into specific playstyles:

- [**Troll Guide**](./pages/Troll_guide.md) — Playing the massive servants of Shadow.
- [**Zaugurz Orc Guide**](./pages/Zaugurz_orc_guide.md) — A guide to the Zaugurz tribe.
- [**Shaman Guide**](./pages/Shaman_Guide.md) — Master the spirits and rituals.
- [**Alweon's Caster Guide**](./pages/Alweon's_Versatile_Caster_Newbie_Guide.md) — Versatile builds for magic users.
- [**Ranger Skills**](./pages/Newbie_Guide_to_Ranger_Skills.md) — Tracking and wilderness survival.
- [**Warrior Skills**](./pages/Newbie_Guide_to_Warrior_Skills.md) — Mastering the art of the blade.
- [**Scout Guide**](./pages/Scout_Guide.md) — Stealth and backstabbing.

## Reference Library

Technical data and lists for quick lookups:

- [**Spell List**](./pages/Spell_list.md) — All spells and their effects.
- [**Herb Guide**](./pages/Herb.md) — Identification and usage of herblores.
- [**Quest Guide**](./pages/Quest.md) — Available quests across Middle-earth.
- [**Character Stats**](./pages/Guide_to_advanced_character_statistics.md) — Deep dive into advanced mechanics.
